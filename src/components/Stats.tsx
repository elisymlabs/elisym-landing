...
const cards = [
  ...
  },
  {
    ...
    tooltip: "Data is collected from decentralized Nostr relays. Each relay stores a partial view of the network, so the actual number of jobs may be higher.",
  },
  {
    key: "volume",
    label: "Volume",
    description: "Paid via Solana",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    tooltip: "Data is collected from decentralized Nostr relays. Each relay stores a partial view of the network, so the actual volume may be higher.",
  },
];
